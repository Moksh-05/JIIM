...
object ExerciseLibrary {
  val allExercises = listOf(
    ...
    ExerciseDefinition("Zottman Curl", "Arms", "Biceps & Brachioradialis"),
    ExerciseDefinition("Dumbbell Bicep Curl", "Arms", "Biceps"),
    ExerciseDefinition("Machine Preacher Curl", "Arms", "Biceps Short Head"),
    ExerciseDefinition("Cable Hammer Curl", "Arms", "Brachialis"),
    ExerciseDefinition("Seated Dumbbell Curl", "Arms", "Biceps"),
    ExerciseDefinition("Tricep Rope Pushdown", "Arms", "Triceps Lateral Head"),
    ExerciseDefinition("Single Arm Cable Tricep Pushdown", "Arms", "Triceps Lateral Head"),
    ExerciseDefinition("Dumbbell Tricep Extension", "Arms", "Triceps Long Head"),
    ExerciseDefinition("Cable Overhead Tricep Extension", "Arms", "Triceps Long Head"),
    ExerciseDefinition("Machine Tricep Extension", "Arms", "Triceps Medial & Lateral Head"),
    ExerciseDefinition("Skull Crushers", "Arms", "Triceps Long Head"),
    ExerciseDefinition("Machine Shoulder Press", "Shoulders", "Anterior Deltoids"),
    ExerciseDefinition("Dumbbell Lateral Raise", "Shoulders", "Side Deltoids"),
    ExerciseDefinition("Cable Lateral Raise", "Shoulders", "Lateral Deltoids"),
    ExerciseDefinition("Reverse Dumbbell Flyes", "Shoulders", "Rear Deltoids"),
    ExerciseDefinition("Front Dumbbell Raise", "Shoulders", "Anterior Deltoids"),
    ExerciseDefinition("Dumbbell Shrug", "Back", "Upper Trapezius"),
    ExerciseDefinition("Machine Chest Press", "Chest", "Pectoralis Major"),
    ExerciseDefinition("Incline Barbell Bench Press", "Chest", "Upper Pectoralis"),
    ExerciseDefinition("Dumbbell Flyes", "Chest", "Pectoralis Major"),
    ExerciseDefinition("Back Extensions", "Back", "Erector Spinae & Glutes"),
    ExerciseDefinition("Ab Crunches", "Core", "Rectus Abdominis"),
    ExerciseDefinition("Reverse Crunches", "Core", "Lower Abdominals"),
    ExerciseDefinition("Pike Push-Ups", "Shoulders", "Anterior Deltoids & Triceps"),
    ExerciseDefinition("Bodyweight Squats", "Legs", "Quadriceps & Glutes"),
